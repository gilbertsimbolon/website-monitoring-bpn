...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <div class="p-4 mx-auto shadow card"
                ...
                <div class="flex-wrap row g-4 align-items-start">
                    ...
                    <div class="col-md-6 d-flex align-items-center">
                        <img src="<?php echo e(asset('img/logo-bpn.png')); ?>" alt="Logo BPN" style="width: 100px; height: auto;" class="me-3">
                        <div>
                    ...
                    <div class="col-md-6">
                        <div class="p-4 bg-white rounded shadow" style="border-radius: 20px;">
                            ...
                            <div class="px-2 py-1 mt-2" style="border: 2px solid green; border-radius: 10px">
                                ...
                                <?php echo $__env->make('components.modal-pengajuan-sertifikat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
        ...
        <?php echo $__env->make('components.modal-pengajuan-berhasil', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> 
...
<?php /**PATH C:\laragon\www\website-monitoring-bpn\resources\views/welcome.blade.php ENDPATH**/ ?>